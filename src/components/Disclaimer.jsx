...
const Disclaimer = () => {
  return (
    <div className="disclaimer">
      ...
      <ul>
        <li>It is based on elemental (and oxide) crystals, most of which are "artificial". The interactions between different elements may not always follow the same trend.</li>
